...
module market_address::market_test {
    ...
    public fun test_module_init() {
        ...
        test_scenario::next_tx(scenario, &initializer);
        {
            ...
            assert!(market::get_lending_pool_id(lending_pool) == market::get_pool_id(&pool_info), 1);
            ...
            assert!(market::get_deposit_balance_by_address(lending_pool, &initializer) == 55, 1);
            // check that a random address has 0 deposits.
            assert!(market::get_deposit_balance_by_address(lending_pool, &random) == 0, 1);
